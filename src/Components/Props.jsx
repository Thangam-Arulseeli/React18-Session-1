...
import {useTime} from "./Theme"  // User defined hook defined in Theme.jsx file

//Example 1 - Funcstional component User is the child component for CurrentUser parent, uses props
function User(props){  // User is the child component
    // Keyword props is used to communicate between the component 
    // name is property created over here
